...
TESTNET_CONFIG = ClientConfig(
    ...
    endpoints=EndpointsConfig(
        ...
        rpc_stream_url="wss://api.starknet.sepolia.extended.exchange/stream.extended.exchange/v2/rpc",
...
MAINNET_CONFIG = ClientConfig(
    ...
    endpoints=EndpointsConfig(
        ...
        rpc_stream_url="wss://api.starknet.extended.exchange/stream.extended.exchange/v2/rpc",
