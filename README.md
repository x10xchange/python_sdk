...
To onboard to the Extended Exchange, the `UserClient` defined in [user_client.py](x10/clients/_user_client/user_client.py) provides a way to use an Ethereum account to onboard onto the Extended Exchange. 
